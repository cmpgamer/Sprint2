...
def recommend(test):
    ...
    print(results)
    queryResults = []
getMovieIDQuery= "select movie_titles.id from movie_titles join movie_years on movie_titles.id = movie_years.movie_id where movie_title = 'Frozen' and year = '2010'"
